module github.com/smallbiznis/transaction
...
require (
	...
	github.com/smallbiznis/go-genproto v0.0.0-20241228104442-44357a5c29e3
	github.com/smallbiznis/go-lib v0.0.0-20240914084120-a17d92ee2db5
